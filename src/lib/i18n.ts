...
const en: Record<Keys, string> = {
  ...
  heroSub:
    "Scale o builds a ready-to-share website for your shop or service in your own language. No computer skills needed.",
...
const dict: Record<LangCode, Record<Keys, string>> = {
  ...
  hi: {
    ...
    heroSub:
      "Scale o आपकी भाषा में आपकी दुकान या सेवा के लिए तैयार वेबसाइट बनाता है. कोई तकनीकी जानकारी नहीं चाहिए.",
  ...
  mr: {
    ...
    heroSub: "Scale o तुमच्या भाषेत तुमच्या व्यवसायाची वेबसाइट तयार करते. तांत्रिक ज्ञान नको.",
  ...
  ta: {
    ...
    heroSub: "Scale o உங்கள் மொழியில் உங்கள் கடைக்கு வலைத்தளம் உருவாக்கும். தொழில்நுட்பம் தேவையில்லை.",
  ...
  te: {
    ...
    heroSub: "Scale o మీ భాషలో మీ వ్యాపారానికి వెబ్‌సైట్ తయారు చేస్తుంది. టెక్నికల్ నాలెడ్జ్ అవసరం లేదు.",
  ...
  bn: {
    ...
    heroSub: "Scale o আপনার ভাষায় আপনার ব্যবসার ওয়েবসাইট তৈরি করে। কোনো টেকনিক্যাল জ্ঞান লাগে না।",
  ...
  gu: {
    ...
    heroSub: "Scale o તમારી ભાષામાં તમારા ધંધાની વેબસાઈટ બનાવે છે. કોઈ ટેકનિકલ જ્ઞાન જરૂરી નથી.",
